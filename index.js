...
newton({ eqn: equation, variable: 'segH', scope: { K: 0.022, span: 1500, segH: 1 }, guess: Math.random() })
bisection({ eqn: equation, variable: 'segH', scope: { K: 0.022, span: 1500, segH: 1 }, guess: Math.random() })
